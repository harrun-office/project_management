...
export function buildDemoSeed() {
  ...
  const tasks = [
    ...
    { id: 'task-5', projectId: 'proj-1', title: 'E2E tests', description: 'Cypress tests for flows', assigneeId: 'user-emp', priority: 'LOW', status: 'COMPLETED', createdById: 'user-admin', createdAt: past3, assignedAt: past3, deadline: past1, tags: [] },
    { id: 'task-6', projectId: 'proj-2', title: 'OpenAPI spec', description: 'Define OpenAPI 3 spec', assigneeId: 'user-2', priority: 'HIGH', status: 'IN_PROGRESS', createdById: 'user-admin', createdAt: past1, assignedAt: todayISO, deadline: in5, tags: [] },
    { id: 'task-7', projectId: 'proj-2', title: 'Auth middleware', description: 'JWT validation middleware', assigneeId: 'user-4', priority: 'HIGH', status: 'TODO', createdById: 'user-admin', createdAt: past1, assignedAt: todayISO, deadline: in7, tags: [] },
    { id: 'task-8', projectId: 'proj-2', title: 'Rate limiting', description: 'Per-client rate limits', assigneeId: 'user-2', priority: 'MEDIUM', status: 'TODO', createdById: 'user-admin', createdAt: todayISO, assignedAt: todayISO, deadline: in14, tags: [] },
    { id: 'task-9', projectId: 'proj-2', title: 'Documentation', description: 'API docs and examples', assigneeId: 'user-4', priority: 'MEDIUM', status: 'TODO', createdById: 'user-2', createdAt: past1, assignedAt: past1, deadline: in7, tags: ['Learning'] },
    { id: 'task-10', projectId: 'proj-2', title: 'Health check endpoint', description: '/health for load balancer', assigneeId: 'user-4', priority: 'LOW', status: 'COMPLETED', createdById: 'user-admin', createdAt: past3, assignedAt: past3, deadline: past1, tags: [] },
    { id: 'task-11', projectId: 'proj-3', title: 'Competitor comparison', description: 'One-pager vs competitors', assigneeId: 'user-3', priority: 'HIGH', status: 'TODO', createdById: 'user-admin', createdAt: todayISO, assignedAt: todayISO, deadline: in7, tags: [] },
    { id: 'task-12', projectId: 'proj-3', title: 'Demo script', description: 'Standard demo script', assigneeId: 'user-5', priority: 'MEDIUM', status: 'IN_PROGRESS', createdById: 'user-3', createdAt: past1, assignedAt: todayISO, deadline: in5, tags: [] },
    { id: 'task-13', projectId: 'proj-3', title: 'Pricing FAQ', description: 'FAQ for pricing questions', assigneeId: 'user-5', priority: 'LOW', status: 'TODO', createdById: 'user-3', createdAt: todayISO, assignedAt: todayISO, deadline: in14, tags: [] },
    { id: 'task-14', projectId: 'proj-4', title: 'Inventory legacy APIs', description: 'List all legacy endpoints', assigneeId: 'user-4', priority: 'MEDIUM', status: 'TODO', createdById: 'user-admin', createdAt: past3, assignedAt: past3, deadline: in3, tags: [] },
    { id: 'task-15', projectId: 'proj-5', title: 'Release notes', description: 'Final release notes', assigneeId: 'user-emp', priority: 'LOW', status: 'COMPLETED', createdById: 'user-admin', createdAt: past3, assignedAt: past3, deadline: past1, tags: [] },
    ...
    { id: 'task-17', projectId: 'proj-6', title: 'Vite setup doc', description: 'Vite + React setup', assigneeId: 'user-2', priority: 'MEDIUM', status: 'TODO', createdById: 'user-emp', createdAt: todayISO, assignedAt: todayISO, deadline: in14, tags: ['Learning'] },
    { id: 'task-18', projectId: 'proj-6', title: 'Code review checklist', description: 'Team checklist for PRs', assigneeId: 'user-4', priority: 'LOW', status: 'TODO', createdById: 'user-admin', createdAt: todayISO, assignedAt: todayISO, deadline: in7, tags: [] },
    { id: 'task-19', projectId: 'proj-1', title: 'Responsive breakpoints', description: 'Define breakpoints', assigneeId: 'user-emp', priority: 'MEDIUM', status: 'TODO', createdById: 'user-2', createdAt: past1, assignedAt: past1, deadline: in5, tags: [] },
    { id: 'task-20', projectId: 'proj-2', title: 'Error responses', description: 'Standard error JSON schema', assigneeId: 'user-4', priority: 'MEDIUM', status: 'TODO', createdById: 'user-admin', createdAt: todayISO, assignedAt: todayISO, deadline: in7, tags: [] },
